...
class Detail extends React.Component<DetailParams, State> {
  state: State;
  ...
  render() {
    ...
    const endFormatter = program.start.isSame(program.end, "day")
      ? "LT"
      : "LLL";
...
export { DetailLink, DetailProps, Detail as default };
